...
**🔴 CRITICAL:** The JWT secret key must be:
...
#### ⭐⭐⭐⭐ 2. TOML Configuration File (Recommended for Single Server)
...
**Advantages:**
- ✅ Automatically generated by pp_configure
- ✅ File-based security with chmod 600
...
- ❌ Harder to rotate in multi-server setups
...
**⚠️ WARNING:** The auto-generated key is lost on restart - all users will need to log in again!
...
- ❌ Different keys across workers
- ❌ Breaks existing user sessions
